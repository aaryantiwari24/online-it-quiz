...
<head>
    ...
    <title>Student Login - IT Quiz</title>
...
<body>
    ...
    <div class="auth-card">
        <h2>Welcome Back</h2>
        <div class="auth-subtitle">Log in to your student portal</div>
        ...
        <form method="POST">
            ...
            <button type="submit" name="login" class="btn-submit">Login to Platform</button>
        </form>
