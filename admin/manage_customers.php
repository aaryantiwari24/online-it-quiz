...
<head>
    ...
    <title>Manage Customers - IT Quiz Admin</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="manage_customers.php" class="sidebar-link active">👥 Customers</a>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($customers)): ?>
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <a href="manage_customers.php?delete=<?php echo $row['customer_id']; ?>" class="btn-danger" onclick="return confirm('Are you sure you want to delete this customer?');">Delete</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="4" style="text-align: center; color: var(--text-secondary); padding: 40px;">No registered customers found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
