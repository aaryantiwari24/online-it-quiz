...
<head>
    ...
    <style>
        ...
        .btn-action { background: var(--brand-primary); color: white; padding: 8px 16px; border-radius: var(--radius-md); font-weight: 600; font-size: 12px; text-decoration: none; transition: var(--transition); display: inline-block; border: none; }
        ...
        <div class="table-card">
            <table>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="7" style="text-align: center; color: var(--text-secondary); padding: 40px;">No certificates issued yet.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
