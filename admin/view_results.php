        ...
        <div class="table-card">
            <table>
                ...
                <tbody>
                    <?php if (mysqli_num_rows($results) > 0): ?>
                        <?php while ($row = mysqli_fetch_assoc($results)): ?>
                            <tr>
                                ...
                                <td style="color: var(--text-secondary); font-size: 13px;"><?php echo date('M d, Y H:i', strtotime($row['attempt_date'])); ?></td>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" style="text-align: center; color: var(--text-secondary); padding: 40px;">No exam results recorded yet.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
