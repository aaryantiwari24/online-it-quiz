...
<head>
    ...
    <style>
        ...
        .form-card, .table-card { background: var(--surface-white); border-radius: var(--radius-lg); border: 1px solid var(--border-light); box-shadow: var(--shadow-subtle); padding: 30px; }
        .form-card h2, .table-card h2 { margin-top: 0; font-size: 18px; font-weight: 800; color: var(--text-primary); margin-bottom: 20px; }
        ...
        .btn-primary { background: var(--brand-primary); color: white; padding: 14px 24px; border-radius: var(--radius-md); font-weight: 600; font-size: 14px; text-decoration: none; cursor: pointer; border: none; width: 100%; transition: var(--transition); display: block; text-align: center; }
            ...
            <div class="form-card">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" placeholder="Briefly describe this category..."></textarea>
                    </div>
            ...
            <div class="table-card">
                ...
                <table>
                    ...
                    <tbody>
                        <?php if (mysqli_num_rows($categories) > 0): ?>
                            <?php while ($row = mysqli_fetch_assoc($categories)): ?>
                                <tr>
                                    ...
                                    <td style="font-size: 13px; color: var(--text-secondary); max-width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="4" style="text-align: center; color: var(--text-secondary); padding: 30px;">No categories found.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
