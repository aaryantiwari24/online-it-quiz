...
if (isset($_POST['update_profile'])) {
    ...
    if (!empty($name) && !empty($email)) {
        // If the user typed a new password, hash it and update it. Otherwise, leave it alone.
        if (!empty($password)) {
            $hashed_password = password_hash($password, PASSWORD_DEFAULT);
            $update_query = "UPDATE supplier SET name = '$name', email = '$email', password = '$hashed_password' WHERE supplier_id = $supplier_id";
        } else {
            $update_query = "UPDATE supplier SET name = '$name', email = '$email' WHERE supplier_id = $supplier_id";
        }
...
$supplier_query = mysqli_query($conn, "SELECT * FROM supplier WHERE supplier_id = $supplier_id");
...
<head>
    ...
    <title>Supplier Profile - IT Quiz Creator</title>
        ...
        <div class="profile-card">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" value="<?php echo htmlspecialchars($supplier['email'] ?? ''); ?>" required>
                </div>
                <div class="form-group">
